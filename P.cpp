...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < T; i++)        //a loop that executes t times
    {
        ...
        ef = pthread_create(&threads[i], NULL, Prime, &tInput[i]); //creating threads which execute the function "Prime" and passing thread number (id) to the function
